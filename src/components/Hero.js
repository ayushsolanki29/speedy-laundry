        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <motion.a 
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md text-white font-semibold px-8 py-4 rounded-full transition-all border border-white/20"
            >
              Call 01494 445291
            </motion.a>
          </motion.div>
          ...
          >
            <motion.div 
              ...
              className="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-5 py-3 rounded-2xl border border-white/10"
            >
