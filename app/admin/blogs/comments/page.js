                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest bg-slate-50 px-2 py-0.5 rounded-full">{new Date(comment.created_at).toLocaleDateString()}</span>
                                            </div>
                                            ...
                                            <div key={reply.id} className="flex gap-4 items-start bg-slate-50/80 p-5 rounded-2xl border border-slate-100/50">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center gap-2 mb-1">
                                                        ...
                                                        <span className="text-[9px] font-bold text-slate-400">{new Date(reply.created_at).toLocaleDateString()}</span>
                                                    </div>
